...
As entry point the Landing Page of the CIS ReferenceableGridCoverage 1.0 is expected.

=== 1. Integrated development environment (IDE)

Use a Java IDE such as Eclipse, NetBeans, or IntelliJ. Clone the repository and build the project.

Set the main class to run: `org.opengis.cite.cisreferenceablegridcoverage1.TestNGController`
...
`java -jar ets-cis-referenceablegridcoverage1-0.1-SNAPSHOT-aio.jar [-o|--outputDir $TMPDIR] [test-run-props.xml]`
